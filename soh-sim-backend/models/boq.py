...
# 添加租户关联
Tenant.correction_templates = db.relationship(
    "CorrectionTemplate", back_populates="tenant"
)
Tenant.algorithm_models = db.relationship(
    "AlgorithmModel", back_populates="tenant"
)

# 添加用户关联
User.correction_templates = db.relationship(
    "CorrectionTemplate", back_populates="created_by_user"
)
User.algorithm_models = db.relationship(
    "AlgorithmModel", back_populates="created_by_user"
)
