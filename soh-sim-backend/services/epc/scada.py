...
def design_scada_ems_service(data):
    ...
    points_per_pcs = 50
    total_points = (
        container_count * points_per_container
        + pcs_count * points_per_pcs
        + 500
    )
    ...
    return {
        "scada_architecture": data.get(
            "scada_architecture", "hierarchical"
        ),
        "communication_protocol": data.get(
