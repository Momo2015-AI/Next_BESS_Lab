FACTOR_DEFAULTS = [
    {
        "id": 1,
        "name": "HV Cable (PoC - MV/HV Transformer)",
        "eta_c": 0.998,
        "eta_d": 0.998,
        "degrade": False,
        "degrade_rate": 0.0,
    ...
    {
        "id": 3,
        "name": "MV Cable (Transformer - LV/MV)",
        "eta_c": 0.998,
        "eta_d": 0.998,
        "degrade": False,
        "degrade_rate": 0.0,
    ...
    {
        "id": 8,
        "name": "DC Cable (DC Panel - Battery Pack)",
        "eta_c": 0.998,
        "eta_d": 0.998,
        "degrade": False,
        "degrade_rate": 0.0,
