...
MANUFACTURERS_DB = [
    {
        ...
        'chemistry_type': 'LFP',
        'calibrated_params': {
            'A_cal': 0.015, 'Ea_cal': 22000, 'alpha': 0.75,
            'A_cyc': 0.0008, 'Ea_cyc': 16000,
            'beta': 0.55, 'gamma': 1.4, 'delta': 0.18,
            'degradation_rate': 0.12
        },
        'rmse_soh': 1.8, 'rmse_rte': 0.8, 'data_points': 156,
    ...
    },
    {
        ...
        'chemistry_type': 'LFP',
        'calibrated_params': {
            'A_cal': 0.016, 'Ea_cal': 21500, 'alpha': 0.78,
            'A_cyc': 0.0009, 'Ea_cyc': 15500,
            'beta': 0.58, 'gamma': 1.35, 'delta': 0.20,
            'degradation_rate': 0.13
        },
        'rmse_soh': 1.9, 'rmse_rte': 0.9, 'data_points': 148,
        'applicable_scenarios': ['LFP日历衰减', '循环衰减', '综合衰减预测', '大规模储能'],
    ...
    },
    {
        ...
        'chemistry_type': 'LFP',
        'calibrated_params': {
            'A_cal': 0.014, 'Ea_cal': 23000, 'alpha': 0.72,
            'A_cyc': 0.0007, 'Ea_cyc': 16500,
            'beta': 0.52, 'gamma': 1.45, 'delta': 0.16,
            'degradation_rate': 0.11
        },
        'rmse_soh': 1.5, 'rmse_rte': 0.7, 'data_points': 200,
    ...
    },
    {
        ...
        'chemistry_type': 'LFP',
        'calibrated_params': {
            'A_cal': 0.013, 'Ea_cal': 24000, 'alpha': 0.70,
            'A_cyc': 0.0006, 'Ea_cyc': 17000,
            'beta': 0.50, 'gamma': 1.50, 'delta': 0.15,
            'degradation_rate': 0.10
        },
        'rmse_soh': 1.4, 'rmse_rte': 0.6, 'data_points': 220,
        'applicable_scenarios': ['LFP日历衰减', '循环衰减', '综合衰减预测', '电网级储能'],
        'description': 'Tesla Megapack LFP系统，适用于电网级储能。首年衰减约2.2%，年均衰减约0.8%，25年末SOH约76%。',
        'is_builtin': True, 'sort_order': 4
    },
    {
        'id': 'lg_es',
        ...
        'chemistry_type': 'LFP',
        'calibrated_params': {
            'A_cal': 0.016, 'Ea_cal': 21000, 'alpha': 0.80,
            'A_cyc': 0.0009, 'Ea_cyc': 15000,
            'beta': 0.60, 'gamma': 1.30, 'delta': 0.22,
            'degradation_rate': 0.14
        },
        'rmse_soh': 2.0, 'rmse_rte': 1.0, 'data_points': 130,
        'applicable_scenarios': ['LFP日历衰减', '循环衰减', '综合衰减预测'],
        'description': 'LG新能源（LGES）LFP电芯，适用于大规模储能。首年衰减约2.7%，年均衰减约1.2%，25年末SOH约69%。',
        'is_builtin': True, 'sort_order': 5
    },
    {
        'id': 'panasonic',
        'name': 'Panasonic',
        ...
        'chemistry_type': 'NMC',
        'calibrated_params': {
            'A_cal': 0.020, 'Ea_cal': 25000, 'alpha': 0.82,
            'A_cyc': 0.0010, 'Ea_cyc': 18000,
            'beta': 0.62, 'gamma': 1.55, 'delta': 0.24,
            'degradation_rate': 0.15
        },
        'rmse_soh': 2.2, 'rmse_rte': 1.1, 'data_points': 110,
        'applicable_scenarios': ['NMC日历衰减', '循环衰减', '综合衰减预测'],
        'description': '松下（Panasonic）NMC电芯，适用于高能量密度场景。首年衰减约3.0%，年均衰减约1.3%，25年末SOH约67%。',
        'is_builtin': True, 'sort_order': 6
    },
]
...
def run_simulation(data):
    ...
    soh, rte = _predict_with_arrhenius(
        data, temperature, cycles_per_day, dod, c_rate, model_params
    )
