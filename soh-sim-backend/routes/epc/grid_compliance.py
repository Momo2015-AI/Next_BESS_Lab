...
from services.epc.grid_compliance import GRID_STANDARDS, analyze_grid_compliance_service
from utils.api_response import error_response, success_response

grid_compliance_bp = Blueprint("epc_grid_compliance", __name__)


@grid_compliance_bp.route("/api/grid-compliance/standards", methods=["GET"])
@token_required
...
@grid_compliance_bp.route("/api/grid-compliance/analyze", methods=["POST"])
@token_required
...
@grid_compliance_bp.route("/api/grid-compliance/<gc_id>", methods=["GET"])
@token_required
