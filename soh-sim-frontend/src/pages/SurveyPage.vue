    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="flex items-center justify-between mb-8">
        ...
        <button
          ...
          "
          onmouseover="
            this.style.backgroundColor = 'var(--color-tab-hover)'
            this.style.borderColor = 'var(--color-accent)'
          "
          onmouseout="
            this.style.backgroundColor = 'var(--color-card-dark)'
      ...
      <form class="space-y-6" @submit.prevent="submitSurvey">
        ...
        <div class="rounded-lg p-6" style="background-color: var(--color-card); border: 1px solid var(--color-border)">
          <h2 class="text-lg font-bold mb-4 flex items-center gap-2" style="color: var(--color-success)">
            <span class="w-2 h-2 rounded-full" style="background-color: var(--color-success)" />
            3. 运行参数
          </h2>
        ...
        <div class="rounded-lg p-6" style="background-color: var(--color-card); border: 1px solid var(--color-border)">
          <h2 class="text-lg font-bold mb-4 flex items-center gap-2" style="color: var(--color-warning)">
            <span class="w-2 h-2 rounded-full" style="background-color: var(--color-warning)" />
            4. 电池选型偏好
          </h2>
        ...
        <div class="rounded-lg p-6" style="background-color: var(--color-card); border: 1px solid var(--color-border)">
          <h2 class="text-lg font-bold mb-4 flex items-center gap-2" style="color: var(--color-info)">
            <span class="w-2 h-2 rounded-full" style="background-color: var(--color-info)" />
            5. 特殊需求（可选）
          </h2>
