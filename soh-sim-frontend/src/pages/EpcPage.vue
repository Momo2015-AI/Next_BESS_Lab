...
const icons = {
  ...
  gridCompliance:
    '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6m11-7h-6m-6 0H1m16.66-5.66l-4.24 4.24M6.58 17.42l-4.24 4.24m0-13.32l4.24 4.24m10.82 10.82l4.24 4.24"/></svg>',
  safety:
  ...
  scada:
    '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 12h5m5 0h5m5 0h5"/><path d="M7 7l5 5 5-5"/><path d="M7 17l5-5 5 5"/></svg>',
