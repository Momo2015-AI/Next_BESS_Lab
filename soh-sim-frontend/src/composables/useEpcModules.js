...
export function useEpcModules(onError) {
  ...
  return {
    // state
    loading,
    archForm, gcForm, sfForm, ippForm, matrixForm, tmForm, seForm, hvForm, bidForm,
    archResult, gcResult, sfResult, ippResult, matrixResult, tmResult, seResult, hvResult, bidResult,
    gridStandards,
    // chart
    chartTypes, chartReady, chartLoading, chartError, activeChart, chartContainer,
    // actions
    designArchitecture, loadStandards, analyzeGridCompliance, analyzeSafety,
    calculateIPP, generateMatrix, calculateThermal, designScada, designHV, generateBidDoc,
    previewChart, purgeChart,
    // utils
    formatNum, statusLabel, statusClass, getDeratingColor
  }
}
