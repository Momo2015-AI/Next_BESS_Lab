<template>
  <div class="flex-1 overflow-auto rounded-xl p-4 space-y-3 card">
    <div>
      ...
      <p class="text-[11px] mt-0.5" style="color: var(--color-text-secondary)">
    ...
    <div
      ...
      style="background: var(--color-bg-secondary); border: 1px solid var(--color-accent-glow)"
    >
      <div class="text-[11px] font-bold" style="color: var(--color-accent)">
        {{ $t('formulaLab.op1Title') }}
      </div>
      <div
        class="p-2.5 rounded font-mono leading-relaxed overflow-x-auto text-[11px]"
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3 font-mono text-[11px]">
        <div class="p-2 rounded space-y-1" style="background: var(--color-bg); border: 1px solid var(--color-border)">
          ...
          <div class="pt-0.5" style="border-top: 1px solid var(--color-border)">
    ...
    >
      ...
      <div
        class="p-2.5 rounded font-mono overflow-x-auto text-[11px]"
        style="background: var(--color-bg); border: 1px solid var(--color-border); color: var(--color-text-secondary)"
      >
        {{ $t('formulaLab.op3Title') }}
        <div
    ...
    <div
      class="p-3 rounded-lg space-y-1.5"
      style="background: var(--color-bg-secondary); border: 1px solid rgba(16, 185, 129, 0.2)"
    >
      ...
      >
        ...
        <div class="mt-1" style="color: var(--color-text-secondary)">
          ...
          />
          MWh ?
          <span style="color: var(--color-success)">"{{ $t('common.yes') }}"</span>
          :
          <span style="color: var(--color-danger)">"{{ $t('common.no') }}"</span>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <div
        class="p-2.5 rounded font-mono overflow-x-auto text-[11px] space-y-2"
        style="background: var(--color-bg); border: 1px solid var(--color-border); color: var(--color-text-secondary)"
      >
        <div>
    ...
    >
      ...
      <div
        class="p-2.5 rounded font-mono overflow-x-auto text-[11px] leading-relaxed"
        style="background: var(--color-bg); border: 1px solid var(--color-border); color: var(--color-text-secondary)"
      >
        Revenue
        <sub>year</sub>
    ...
    <div
      class="p-3 rounded-lg space-y-1.5"
      style="background: var(--color-bg-secondary); border: 1px solid rgba(6, 182, 212, 0.2)"
    >
      ...
      >
        ...
        >
          <div class="flex justify-between items-center mb-2">
            <span class="text-xs font-bold" style="color: var(--color-accent-secondary)">
          ...
          <div
            class="text-[10px] font-mono rounded p-2 leading-relaxed"
            style="background-color: var(--color-input-bg-dark); color: var(--color-text)"
          >
            DC_Aux = [(
            ...
            kW) + (
            <span style="color: var(--color-text-muted)">24</span>
            h -
            <input v-model.number="auxState.cycles" type="number" step="0.5" class="formula-input w-8" />
            次 ×
            <input v-model.number="auxState.hours" type="number" step="0.5" class="formula-input w-8" />
        ...
        >
          ...
          <div
            class="text-[10px] font-mono rounded p-2"
            style="background-color: var(--color-input-bg-dark); color: var(--color-text)"
          >
