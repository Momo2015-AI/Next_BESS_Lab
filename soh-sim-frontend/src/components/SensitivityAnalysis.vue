        ...
        <div class="rounded-lg p-3" style="background-color: var(--color-card-dark);">
          ...
          <div class="space-y-2">
            <label v-for="param in sensitivityParams" :key="param.key"
              ...
              <input type="checkbox" v-model="param.enabled" style="accent-color: var(--color-accent);">
        ...
        <div class="col-span-3 rounded-lg p-3" style="background-color: var(--color-card-dark);">
          ...
          <div class="grid grid-cols-3 gap-3">
            <div v-for="param in enabledParams" :key="param.key">
              <div class="text-xs mb-1" style="color: var(--color-text-secondary);">{{ param.label }}</div>
              <div class="flex items-center gap-1">
                <input v-model.number="param.min" type="number" step="0.01"
                  class="w-16 rounded text-xs px-2 py-1" style="background-color: var(--color-input-bg-dark); border: 1px solid var(--color-input-border); color: var(--color-text);"
