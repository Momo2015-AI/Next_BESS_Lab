    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 mb-4">
      <div class="rounded-xl p-4" style="background-color: var(--color-card); border: 1px solid var(--color-border)">
        ...
        <div class="text-2xl font-bold" style="color: var(--color-text)">
          ...
          <span class="text-sm ml-1" style="color: var(--color-accent-secondary)">MWh</span>
        </div>
      </div>
      <div class="rounded-xl p-4" style="background-color: var(--color-card); border: 1px solid var(--color-border)">
        ...
        <div class="text-2xl font-bold" style="color: var(--color-text)">
          ...
          <span class="text-sm ml-1" style="color: var(--color-accent-secondary)">kWh/台·天</span>
        </div>
      </div>
      <div class="rounded-xl p-4" style="background-color: var(--color-card); border: 1px solid var(--color-border)">
      ...
      <div class="rounded-xl p-4" style="background-color: var(--color-card); border: 1px solid var(--color-border)">
        <div class="text-xs font-bold mb-2" style="color: var(--color-text-muted)">选定天数内累计运行时间</div>
        <div class="text-2xl font-bold" style="color: var(--color-text)">
          {{ results.tRun.toFixed(1) }}
          <span class="text-sm ml-1" style="color: var(--color-accent-secondary)">小时</span>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div class="rounded-xl p-4" style="background-color: var(--color-card); border: 1px solid var(--color-border)">
        <h3 class="text-sm font-medium mb-4 flex items-center gap-2" style="color: var(--color-text-secondary)">
          <span class="w-1 h-4 rounded" style="background-color: var(--color-accent-secondary)" />
          仿真参数全局调节
        </h3>
