  ...
  <div class="grid grid-cols-2 gap-3">
    ...
    <div class="rounded-lg p-3 ins-1">
      <h3 class="font-bold text-xs mb-2 flex items-center gap-2 ins-2">
        <span
          class="w-5 h-5 rounded text-[10px] flex items-center justify-center font-bold ins-3"
    ...
    <div class="rounded-lg p-3 ins-1">
      <h3 class="font-bold text-xs mb-2 flex items-center gap-2 ins-2">
        <span
          class="w-5 h-5 rounded text-[10px] flex items-center justify-center font-bold ins-7"
    ...
    <div class="rounded-lg p-3 ins-1">
      <h3 class="font-bold text-xs mb-2 flex items-center gap-2 ins-2">
        <span
          class="w-5 h-5 rounded text-[10px] flex items-center justify-center font-bold ins-8"
    ...
    <div class="rounded-lg p-3 ins-1">
      <h3 class="font-bold text-xs mb-2 flex items-center gap-2 ins-2">
        <span
          class="w-5 h-5 rounded text-[10px] flex items-center justify-center font-bold ins-9"
    ...
    <div class="rounded-lg p-3 ins-1">
      <h3 class="font-bold text-xs mb-2 flex items-center gap-2 ins-2">
        <span
          class="w-5 h-5 rounded text-[10px] flex items-center justify-center font-bold ins-10"
...
const f = inject('financialParams', () => {
  ...
  return {
    offPeakPrice: 0.3, peakPrice: 0.8, spreadCapture: 85, operatingDays: 330,
    capacityPrice: 30000, ancillaryPrice: 15000, priceEscalation: 2.0, efficiencyLossPct: 3.0,
    containerCost: 200000, pcsCost: 80000, bopCost: 50000, epcCost: 100000,
    developmentCost: 50000, omCost: 5000, insuranceRate: 0.5, propertyTaxRate: 0.2,
    debtRatio: 60, loanRate: 4.5, loanTerm: 15, depreciationYears: 15,
    residualRate: 5, taxRate: 25, taxHoliday: 5, discountRate: 8.0,
    augContainerCost: 180000, augInterval: 5, augRatio: 10,
    capexVolatility: 15, priceVolatility: 20, sensPct: 15,
  }
})
</script>
...
.ins-3 { background-color: var(--color-accent-glow); color: var(--color-accent) }
.ins-4 { color: var(--color-text-secondary) }
...
.ins-7 { background-color: rgba(245, 158, 11, 0.2); color: var(--color-warning) }
.ins-8 { background-color: rgba(59, 130, 246, 0.2); color: var(--color-accent-secondary) }
.ins-9 { background-color: rgba(168, 85, 247, 0.2); color: var(--color-info) }
.ins-10 { background-color: rgba(16, 185, 129, 0.2); color: var(--color-success) }
</style>
