        ...
        <div class="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
          ...
          <div class="space-y-3">
            <div>
              ...
              <select v-model="selectedPcsId" @change="onPcsChange" class="w-full bg-slate-900 border border-slate-600 rounded px-2 py-1.5 text-xs focus:border-sky-500 outline-none">
